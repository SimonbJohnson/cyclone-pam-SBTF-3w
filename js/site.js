...
var config = {
    ...
    description:"<p>Click the graphs or map to interact.<br />Date: 25/03/2015<br />Contact: <a href='https://twitter.com/Simon_B_Johnson' target='_blank'>Simon Johnson</a><br />Source: <a href='http://blog.standbytaskforce.com/' target='_blank'>Stand By Task Force</a></p>",
    data:"data/data.json",
    ...
    colors:['#81d4fa','#4fc3f7','#29b6f6','#b12930','#039be5','#0288d1','#0277bd','#01579b']
};
...
function generate3WComponent(config,data,geom){    
    ...
    whatChart.width($('#hdx-3W-what').width()).height(142)
